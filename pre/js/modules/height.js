...
function setChartHeight(iframe) {
    if(iframe == 'fixed') {
        ...
        document.getElementsByClassName('container')[0].style.height = '454px';
        document.getElementsByClassName('main')[0].style.height = '426px';
        ...
        let height = 426; //Altura total del main
